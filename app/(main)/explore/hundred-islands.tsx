...
const DestinationScreen = () => {
  ...
  return (
    <ScrollView style={tw`bg-white`} contentContainerStyle={tw`pb-20`}>
      ...
      {/* Image Banner */}
      <Image
        source={require("../../../assets/images/inside_hundred.jpg")} // Change image as needed
        style={{
          width,
      ...
      <View style={tw`px-5 pt-6`}>
        ...
        <Text style={tw`text-base text-gray-700 mb-5 leading-relaxed`}>
          The Hundred Islands National Park in Alaminos, Pangasinan, is a
          beautiful collection of 124 islands (123 at high tide) scattered
          across the Lingayen Gulf. These islands feature lush greenery, white
          sand beaches, and are rich in biodiversity.
        </Text>
        ...
        <View style={tw`ml-3`}>
          {["Island hopping", "Snorkeling", "Kayaking", "Cliff diving"].map((activity, index) => (
